...
const ModelViewer: FC<ViewerProps> = ({
  ...
  return (
    <div style={{ width, height }} className="relative cursor-grab active:cursor-grabbing">
      <Canvas
        shadows
        camera={{
          fov: 50,
          position: [6, 0, defaultZoom],
          near: 0.01,
          far: 100,
        }}
        gl={{
      ...
      >
        ...
        <OrbitControls
          ...
          // Vertical: limitar la cámara para que no se vea desde arriba
          minPolarAngle={Math.PI / 3}  // 45° desde arriba
          maxPolarAngle={Math.PI / 1.5}  // horizontal

          // Horizontal: limitar rotación a ±30°
          minAzimuthAngle={-Math.PI / 12} // -30° izquierda
          maxAzimuthAngle={Math.PI / 2}  // +30° derecha
        />
      </Canvas>
    </div>
  );
