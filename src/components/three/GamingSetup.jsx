...
Command: npx gltfjsx@6.5.3 public/models/gaming-setup.glb --transform 
Files: public/models/gaming-setup.glb [35.9MB] > C:\Users\juank\juank\hobbies\portfolio-juankui\gaming-setup-transformed.glb [3.25MB] (91%)
...
export function GamingSetup(props) {
  const { nodes, materials } = useGLTF('models/gaming-setup-transformed.glb')
  return (
...
useGLTF.preload('models/gaming-setup-transformed.glb')
